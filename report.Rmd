...
### Simulated DE genes per cluster

In the following upset plots we observe the number of genes that were simulated as differentially expressed per cluster for the muscat and for the correlation structure. Apparenty, both frameworks present similar results as they have been simulated under alike experimental conditions.
   
![](Upset_plot_muscat.png)
*Upset Plot of simulated DE genes per cluster in muscat simulation*  
   
![](Upset_plot_correlation_structure.png)
  
*Upset Plot of simulated DE genes per cluster in correlation structure simulation*  
