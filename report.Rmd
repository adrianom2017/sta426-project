...
for (method in methods){
  ...
  if (grepl("mm_",method)){
    ...
    ds <- DS.analysis.mm(sim,method_substring[2],vst,topnumber,method)
    
    #Visualization
    p <- DS.analysis.Visualization.mm(ds,method_substring[2],method_substring[1],method_substring[3],topnumber,method,num)
    ...
    #DS pb analysis
    ds <- DS.analysis.pd(sim,method_substring[2],method_substring[1],method_substring[3], topnumber,method)
    #Visualization
    p <- DS.analysis.Visualization.pb(ds,method_substring[2],method_substring[1],method_substring[3],topnumber,method,num)
 ...
 # print("Hello")
  ...
  #break
  #if (method == "sum_counts_edgeR"){
  #  pval_total <- data.frame(matrix(0, ncol = 0, nrow = nrow(ds$tbl)))
  #  padj_total <- data.frame(matrix(0, ncol = 0, nrow = nrow(ds$tbl)))
  #  truth_total <- data.frame(matrix(0, ncol = 0, nrow = nrow(ds$tbl)))
  #}
 
 
  #print(dim(ds$pval))
  #print(dim(pval_total))
  

  #print(pval_total)
  #pval_total <- cbind(pval_total,ds$pval)
  #padj_total <- cbind(padj_total,ds$padj)
  #truth_total <- cbind(truth_total,ds$truth)
...
#print(padj_total)
#print(truth_total)
#Plot.TPR.vs.FDR(pval_total,padj_total,truth_total)
