...
for (method in methods){
  ...
  if (grepl("mm_",method)){
    ...
    print(method)
    ds <- DS.analysis.mm(sce_muscat,method_substring[2],method_substring[1],vst,topnumber)
    ...
    #DS pb analysis
    ds <- DS.analysis.pd(sce_muscat,method_substring[2],method_substring[1],method_substring[3], topnumber)
    #Visualization
...
for (method in methods){
  ...
  if (grepl("mm_",method)){
    ...
    print(method)
    ds <- DS.analysis.mm(sce_sim,method_substring[2],method_substring[1],vst,topnumber)
    ...
    #DS pb analysis
    ds <- DS.analysis.pd(sce_sim,method_substring[2],method_substring[1],method_substring[3], topnumber)
    #Visualization
    p <- DS.analysis.Visualization.pb(ds,method_substring[2],method_substring[1],method_substring[3],topnumber,num)
